          ...
          <form>
            <div class="header flex-between flex-vertical-center">
              <div class="flex-vertical-center">
                ...
                <span class="title">
                  <strong>Payment</strong><span>Process</span>
                </span>
              </div>
            </div>
            <div class="card-data flex-fill flex-vertical">
                ...
                <div class="card-number flex-vertical-center flex-fill">
                  <div class="card-number-field flex-vertical-center flex-fill">
                    <input type="text" placeholder="Card Number" class="form-control" id="cardNumber"
                      onkeypress="return onlyNumberKey(event)" maxlength="19" name="cardNumber"
                      data-bound="carddigits_mock" data-def="0000 0000 0000 0000" required />
                  </div>
              ...
              <div class="flex-between">
                ...
                <div class="card-property-value">
                  <div class="input-container">
                    <input id="cvc" placeholder="Card CVV" maxlength="3" onkeypress="return onlyNumberKey(event)"
                      type="password" />
                  </div>
                </div>
              </div>
              ...
              <div class="flex-between">
                ...
                <div class="card-property-value">
                  <div class="input-container">
                    <input id="name" data-bound="name_mock" data-def="Mr. Cardholder" type="text" class="uppercase"
            ...
            <div class="action flex-center">
              <button type="submit" class="btn btn-primary btn-lg bod-3">
                Pay Now
              </button>
            </div>
          </form>
...
button:hover {background: linear-gradient(45deg, #007bff, #0056b3);
  border: none;
  color: white;
  padding: 10px 20px;
  font-size: 16px;
