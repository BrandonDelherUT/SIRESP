        ...
        <div class="navbar-menu">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu" v-if="isDropdownOpen" @click="toggleDropdown">
              ...
              <a v-if="isUser" class="dropdown-item" href="/registroAnfitrion">Registrarse como Anfitrión</a>
              <a v-if="isHost" class="dropdown-item" href="/modificarAnfitrion">Modificar datos de Anfitrión</a>
              <a v-if="isUser" class="dropdown-item" href="/alojamiento">Mostrar mis alojamientos</a>
              <a v-if="isUser" class="dropdown-item" href="/insertarAlojamiento">Insertar Alojamiento</a>
